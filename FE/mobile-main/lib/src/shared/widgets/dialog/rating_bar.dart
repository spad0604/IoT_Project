...
class RatingBar extends StatefulWidget {
  ...
  const RatingBar.builder({
    ...
    required IndexedWidgetBuilder unratedBuilder,
    required this.onRatingUpdate,
    this.glowColor,
    this.maxRating,
    this.textDirection,
    ...
    this.wrapAlignment = WrapAlignment.start,
        ...
        _unratedBuilder = unratedBuilder,
        _ratingWidget = null;
  ...
  final IndexedWidgetBuilder? _unratedBuilder;
...
class _RatingBarState extends State<RatingBar> {
  ...
  Widget _buildRating(BuildContext context, int index) {
    ...
    final Widget? unrated = widget._unratedBuilder?.call(context, index);
