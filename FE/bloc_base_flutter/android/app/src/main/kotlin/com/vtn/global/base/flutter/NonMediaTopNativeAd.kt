...
class NonMediaTopNativeAd(private val context: Context) : GoogleMobileAdsPlugin.NativeAdFactory {
    override fun createNativeAd(
        ...
        val adView =
            LayoutInflater.from(context)
                .inflate(R.layout.non_media_top_native_ad, null) as NativeAdView
