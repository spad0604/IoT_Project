...
abstract class $AppStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Language currentLanguage, String errorMessage});
}
...
class _$AppStateImpl implements _AppState {
  const _$AppStateImpl(
      {this.currentLanguage = Language.english, this.errorMessage = ''});
  ...
  @override
  String toString() {
    return 'AppState(currentLanguage: $currentLanguage, errorMessage: $errorMessage)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, currentLanguage, errorMessage);
